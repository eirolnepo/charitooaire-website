...
<head>
    ...
    <title>Installation Prices</title>
    ...
    <main>
        <div id="content-container">
            ...
            <div class="aircontype-containers">
                <a href="bookings.php?service=installation&aircon=wallmounted">
                    <div class="aircontype-container">
                        <div class="service">
                            <img src="../imgs/wall mounted.png" alt="">
                            <h4 class="text">Wall Mounted</h4>
                            <p class="text">Starts at P 9,500.00</p>
                        </div>
                    </div>
                </a>
                <a href="bookings.php?service=installation&aircon=windowtype">
                    <div class="aircontype-container">
                        <div class="service">
                            <img src="../imgs/window type.png" alt="">
                            <h4 class="text">Window type</h4>
                            <p class="text">Starts at P 5,000.00</p>
                        </div>
                    </div>
                </a>
                <a href="bookings.php?service=installation&aircon=floormounted">
                    <div class="aircontype-container">
                        <div class="service">
                            <img src="../imgs/floor mounted.png" alt="">
                            <h4 class="text">Floor Mounted</h4>
                            <p class="text">Starts at P 12,000.00</p>
                        </div>
                    </div>
                </a>
                <a href="bookings.php?service=installation&aircon=ceillingcassette">
                    <div class="aircontype-container">
                        <div class="service">
                            <img src="../imgs/ceiling cassette.png" alt="">
                            <h4 class="text">Ceiling Cassette</h4>
                            <p class="text">Starts at P 15,000.00</p>
                        </div>
                    </div>
                </a>
                <a href="bookings.php?service=installation&aircon=ceillingsuspended">
                    <div class="aircontype-container">
                        <div class="service">
